<template>
  <div class="fasecrecimento">
    ...
    <div style="margin-bottom: 20px">
      <p class="title-page">Atendimentos</p>
    </div>
    <div class="grid">
      <table-ticket classname="fases_crecimento" :onGetById="onGetById" :columns="fields" ref="datagrid"/>
    </div>
    <div>
      <Dialog :style="{width: '30vw'}" header="Cadastro Fases Crecimento" v-model:visible="showModal" :modal="true">
        <div class="p-fluid row">
          <div class="p-field col-sm-12">
              <label for="win_fasecrecimento_descricao">Descricao</label>
              <InputText v-model="form.descricao" id="win_fasecrecimento_descricao" type="text" />
          </div>
        </div>
        <template #footer>
